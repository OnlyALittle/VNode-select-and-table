  ...
  methods: {
    ...
    updateHeight () {
      if(!!this.appendNum)
        ...
        this.itemNum = 2 * Math.ceil(this.height / this.rowHeight);
    ...
    initGroupHeight (data) {
      ...
      let moduleNb = 0;
      if(!!this.appendNum){
        moduleNb = Math.ceil(this.height / this.rowHeight) + this.appendNum;
      }else{
        moduleNb = 2 * Math.ceil(this.height / this.rowHeight);
      }
